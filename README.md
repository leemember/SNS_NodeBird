# 💌 NodeBird SNS
> <B>노드버드 강의 현재 진행 상황</b> : 3월 1일 현재 시점, 지금 내 상태에서 리덕스 사가까지 완벽하게 구현 할 수 있는 것이 더 중요한 것 같으니, 제로초님 노드버드 강의 중 redux-saga 까지 여러번 리플레이 해서 이해하고 <b>소스보면 이게 왜 이렇게 짰고 어떤 흐름인지 알아볼 수 있는 수준까지 도달</b>하면 그때 되어서 다시 백엔드 강의부터 듣고 next 공부해보자. 
